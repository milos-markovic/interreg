...
@section('body')
        ...
        <div class="max-w-screen-desktop mx-auto px-5 xl:px-0">
            <div class="border-l-2 border-gray-200 p-3">
                <div id="breadcrumb" class="mb-2">
                    <ul class="flex">
                        <li><a href="/" class="text-xs lg:text-base">Početna</a></li>
                        <li class="mx-3">/</li>
                        <li><a href="" class="text-xs lg:text-base text-gray-400">Aktuelnosti i galerija</a></li>
                    </ul>
                </div>
                    
                <h1 class="text-2xl lg:text-4xl font-secondary">Aktuelnosti i galerija</h1>
            </div>
        </div>
    </header>
    ...
    <section>
        ...
        <div class="max-w-screen-desktop mx-auto mt-16 lg:mt-32 px-5 xl:px-0 ">
             ...
             @foreach($gallery->where('language','Sr') as $post)
